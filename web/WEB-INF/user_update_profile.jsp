...
<html>
    ...
    <body background="img/bg-metal.jpg">
        ...
        <form action="/blog/UserUpdateProfileControl" name="update_profile" id="update_profile" method="post">
            <div style="text-align: center;" class="animated slideInDown">
                <h2 style="color:#ffffff;"><b>Update Profile</b></h2>
            </div>
            <br/><br/><br/>
            <div class="container">
                ...
                <div class="inner-addon left-addon col-md-4">
                    ...
                    <input type="text" name="realName" class="form-control" form="update_profile" placeholder="Real Name"/>
                </div>
                <div class="col-md-4"></div>
            </div>
            <div class="container">
            ...
            <div class="container">
                ...
                <div class="col-md-4">
                    <label>Birthday
                        <input type="date" name="birthday" class="form-control" form="update_profile"/>
                    </label>
                </div>
                <div class="col-md-4"></div>
            </div>
            <div class="container">
                ...
                <div class="col-md-4">
                    <label for="country">Country
                        <select name="country" class="form-control" id="country" form="update_profile">
                            <option value=""></option>
